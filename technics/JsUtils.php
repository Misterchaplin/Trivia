...
class JsUtils {
	...
	public static function _dialog($divTarget, $buttonClass, $text, $function=""){

		$retour="$( '$divTarget' ).dialog({
			resizable: false,
			height:200,
			modal: true,
			buttons: [{
	...
	public static function dialog($divTarget,$buttonClass,$text){
		return JsUtils::addScript(JsUtils::_dialog($divTarget, $buttonClass, $text));
	}
	
	public static function _dialogPlus($url, $form, $divTarget, $divTargetText, $button, $buttonPlus, $buttonFinish, $text, $textFinish, $textPlus,$responseElement, $function=""){
	...
	public static function dialogPlus($url, $form, $responseElement, $divTarget, $divTargetText, $button, $buttonPlus, $buttonFinish, $text, $textFinish, $textPlus, $function=""){
	return JsUtils::addScript(JsUtils::_dialogPlus($url, $form, $responseElement, $divTarget, $divTargetText, $button, $buttonPlus, $buttonFinish, $text, $textFinish, $textPlus, $function=""));
	}
